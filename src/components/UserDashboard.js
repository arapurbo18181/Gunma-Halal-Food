    ...
    <section className="flex justify-start items-center xl:mx-4 w-[100%]">
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 place-items-center w-full">
        {CardsForUserDashboard.map((item, i) => {
          return (
            <div key={i} className="border flex flex-col justify-center items-center h-40 w-full xl:w-80 px-4 py-2 bg-gradient-to-t from-emerald-600 to-emerald-200 hover:-translate-y-1 ease-in-out transition-all duration-500 overflow-hidden">
